...
function totalTimeSpent(cakeLayers, minutesInOven) {
  const prepTime = calculatePreparationTime(cakeLayers)
  const totalTimeSpent = prepTime + minutesInOven
  return totalTimeSpent
}

console.log(
  `I wasted ${totalTimeSpent(3, 10)} Minutes of my life to create this cake.`
)
